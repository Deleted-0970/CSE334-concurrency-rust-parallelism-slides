...
fn change_color_to(new_color: Color) {
    match new_color {
        Color::Red => set_color([255, 0, 0]),
        Color::Blue => set_color([0, 0, 255]),
        Color::Custom(c) => set_color(c),
    }
}
*/
...
fn change_color_to(new_color: Color, custom_color_if_applicable: [u8; 3]) {

}

fn i_want_green() {
    change_color_to(Color::Green, [0, 0, 0]); // THIS IS BAD
}
*/
